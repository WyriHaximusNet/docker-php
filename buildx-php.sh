...
declare -r VERSION_OS_TAG=$6

declare -r VERSION_OS_FROM=$7

declare -r REGISTRY=$8
...
declare -r WYRIHAXIMUSNET_TAG="${REGISTRY}/wyrihaximusnet/php:${VERSION_PHP}-${DST_IMAGE}-${VERSION_OS_TAG}"
